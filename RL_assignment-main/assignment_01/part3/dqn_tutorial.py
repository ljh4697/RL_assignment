...
-   `action` â€” the action to be taken (in this case, `0` or `1`)
-   `state` â€” used for stateful (that is, RNN-based) policies
-   `info` â€” auxiliary data, such as log probabilities of actions
"""
