    ...
    for e in range(num_episode):
        ...
        while not done:
            ...
            if done:
                ...
                # 에피소드마다 학습 결과 출력
                score_avg = 0.8 * score_avg + 0.2 * score if score_avg != 0 else score
                print("step: {:3d} | episode: {:3d} | score avg: {:3.2f} | memory length: {:4d} | epsilon: {:.4f}".format(
                    i, e, score_avg, len(agent1.memory), agent1.epsilon))
